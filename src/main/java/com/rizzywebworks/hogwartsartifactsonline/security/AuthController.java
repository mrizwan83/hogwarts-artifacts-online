...
public class AuthController {
    ...
    //also a good idea to use a logger in this class
    ...
    //this method returns the basic user login info and json web token
    // we are getting the authentication from spring security core
